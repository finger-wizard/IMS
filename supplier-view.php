...
<title>View Suppliers | Retactics</title>
...
<td><?= date('M d, y @ h:i:s A', strtotime($supplier['updated_at']))?></td>
 <td>
    <a href="" class="updateSupplier" data-sid="<?= $supplier['Id']?>"><i class="fa fa-pencil"></i> Change</a> |
    <a href="" class="deleteSupplier" data-name="<?= $supplier['supplier_name']?>" data-sid="<?= $supplier['Id']?>"><i class="fa fa-trash"></i> Remove</a>
...
BootstrapDialog.confirm({
    ...
    message: 'You really want to delete <strong>'+supplierName+'</strong>?',
    callback: function(isDelete){
      if(isDelete){
            ...
            success: function(data){
               ...
               supplierName + ' successfully deleted!' : 'Error! proccessing your request';
